...
export const projects = [
  ...
  },
  {
    ...
    overview: {
      ...
      scope: "웹 UI/UX 기획·화면 디자인, HTML/CSS 퍼블리싱, 온·오프라인 브랜드 콘텐츠 제작",
    ...
    screenCaptions: ["조선일보 지면광고 배너", "3단 리플렛 — 앞면", "3단 리플렛 — 뒷면"],
    screens: [
  ...
  },
  {
    ...
    flyerCaptions: ["전단지 — 설치 안내 & 실제 설치 사례", "전단지 — 서비스 소개 & 판매랭킹"],
